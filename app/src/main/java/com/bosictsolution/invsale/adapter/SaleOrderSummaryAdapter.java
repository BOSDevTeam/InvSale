...
public class SaleOrderSummaryAdapter extends RecyclerView.Adapter<SaleOrderSummaryAdapter.ViewHolder> {
    ...
    public SaleOrderSummaryAdapter(Context context, List<SaleOrderTranData> list, boolean isAllowEdit) {
        this.list = list;
