...
public class ListItemSaleAdapterR extends RecyclerView.Adapter<ListItemSaleAdapterR.ViewHolder> {
    ...
    public ListItemSaleAdapterR(Context context, List<SaleTranData> list,boolean isAllowEdit) {
        this.list = list;
