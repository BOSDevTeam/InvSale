...
public class BtService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction().equals(PrintUtil.ACTION_PRINT_TEST)) {
            ...
            printBitmapTest(BTPrinterSettingActivity.paperWidth);
    ...
    private void printTest() {
        try {
            ...
            bytes.add(com.bosictsolution.invsale.bluetooth.print.GPrinterCommand.reset);
            bytes.add(message.getBytes("gbk"));
            bytes.add(com.bosictsolution.invsale.bluetooth.print.GPrinterCommand.print);
            bytes.add(com.bosictsolution.invsale.bluetooth.print.GPrinterCommand.print);
            bytes.add(com.bosictsolution.invsale.bluetooth.print.GPrinterCommand.print);
